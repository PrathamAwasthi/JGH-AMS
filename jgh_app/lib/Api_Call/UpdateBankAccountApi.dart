...
class UpdateBankAccountApi_ApiCall {
  static Future<int> updateBankAccountApi(BuildContext context, { required String id, required String accountHolderName, required String bankName, required String accountNumber, String upi_Id = "", required String ifscCode}) async{
    try{
      var url = Uri.parse(AppConst.bankAccountUpdateUrl);
      var headers = {
      ...
      if(response.statusCode == 200){
        ...
        if(data["status"]=="success"){
          Fluttertoast.showToast(
            msg: "Bank account Successfully updated",
            toastLength: Toast.LENGTH_SHORT,
            gravity: ToastGravity.CENTER,
            timeInSecForIosWeb: 1,
